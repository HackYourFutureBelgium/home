...
> You will build your final project from this [starter repository](). It comes pre-packaged with the everything you need for continuous integration testing, and continuous deployment.
