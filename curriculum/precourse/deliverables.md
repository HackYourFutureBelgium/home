...
Are your ready to rock and roll?! Below are some assignments to complete _before_ the first day of class, if you finish them all you should be ready to hit the ground running. You will need to check all these boxes to join the first class!

- [0. Study Tips](#0-study-tips)
- [1. Create Your Issue](#1-create-your-issue)
- [2. Install Software](#2-install-software)
- [3. Install VSCode Extensions](#3-install-vscode-extensions)
- [4. Organize Your Computer](#4-organize-your-computer)
- [5. GitHub Setup](#5-github-setup)
- [6. Flashcards Repository](#6-flashcards-repository)
- [7. Student Bio PR](#7-student-bio-pr)

---

## 0. Study Tips

Begin reading through the Student Guidebook's [Study Tips](https://home.hackyourfuture.be/students/study-tips). It's full of great links to get you ready for learning.
...
Fork the [HackYourFutureBelgium/flashcards]() repository to your GiHub account. You will be using this through HYF to build your own collection of interactive flashcards. Paper flashcards are also great! There's some tips in the repository for how to create, study and manage flashcards (paper and computer)

## 7. Student Bio PR

instructions are in `/student-bio` of your class repo
