...
We also ask you **not to use fake names** - as you will use this channel for advice and feedback it will be helpful if your mentors know who is who. Adding **a photo** to your profile is *required* :)
...
Git and GitHub are how you will do *everything* while at HackYourFuture. Homework submission, Sunday classes, projects, collaboration, coach feedback, *everything*! The more time you spend studying Git and GitHub before class starts, the easier it will be to focus on the fun stuff.
