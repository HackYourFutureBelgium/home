...
You are a new student and can't wait to start your HYF journey. We know that! As a community who wants to make the web a better place, we are very happy to have you onboard.

With this Precourse, you can get ready for your very first class of the HYF program. Enjoy!
...
* [What to expect at HYF?](precourse.md#what-to-expect-at-hyf)
* [What tools do we use?](precourse.md#what-tools-do-we-use)
* [How do we teach?](precourse.md#how-do-we-teach)
* [Precourse Assignments](precourse.md#precourse-assignments)
* [Good Reads](precourse.md#good-reads)
...
Please read the _'Learning chapter'_ in our [**Study Guidebook**](https://study.hackyourfuture.be/learning). It will help you become a great HackYourFuture Student. We also expect you to know our:
...
* :egg: Complete this [Markdown Tutorial](https://www.markdowntutorial.com/)
* :hatching\_chick: Practice [previewing markdown files with Visual Studio Code](https://code.visualstudio.com/Docs/languages/markdown)
...
* [Git and GitHub for Poets](https://www.youtube.com/playlist?list=PLRqwX-V7Uu6ZF9C0YMKuns9sLDzK6zoiV)
  * :egg: 1.1, 1.2, 1.3, 1.4
  * :hatching\_chick: Move on in the tutorial and learn how to use Git from the terminal
...
Do you already know coding is fun? Spend some more time getting used to programming, and have a little fun while you're at it.

* :egg: [compute-it.toxicode](http://compute-it.toxicode.fr/) and [little-dot.toxicode](http://little-dot.toxicode.fr/)
* :hatching\_chick: [Do some creative coding with P5.js](https://p5js.org)
...
* :hatched\_chick: Develop your P5.js sketches on your computer using VSC, push them to GitHub, and turn on GitHub Pages for a live demo!
